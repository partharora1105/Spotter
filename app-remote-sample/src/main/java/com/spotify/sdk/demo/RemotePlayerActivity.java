...
public class RemotePlayerActivity extends FragmentActivity {
  ...
  private void sendNotification(String trackTitle) {
    // Create a notification channel for Android Oreo and higher
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
      CharSequence name = "Spotify Vuzix";
      String description = "Notif for spotify vuzix to change";
    ...
    NotificationCompat.Builder builder = new NotificationCompat.Builder(this, "1")
            ...
            .setContentText("Playing : " + trackTitle)
            .setPriority(NotificationCompat.PRIORITY_DEFAULT)
            .setAutoCancel(true);

    // Show the notification
    NotificationManagerCompat notificationManager = NotificationManagerCompat.from(this);
    // Notification ID allows you to update the notification later on if needed
